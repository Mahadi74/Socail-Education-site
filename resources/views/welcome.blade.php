<html lang="en">
    <head>
     ...
     font-size: 12px;
     background-image: url(public/img/home10.png);
            }
ul{
  position: absolute;
  top: 50%;
...
ul li:hover:nth-child(1) before a{
  background: #2e4a86;
}
ul li:hover:nth-child(1) after a{
  background: #4a69ad;
}
ul li:hover:nth-child(2) a{
  background: #D6F45B;
}
ul li:hover:nth-child(2) before a{
  background: #2e4a86;
}
ul li:hover:nth-child(2) after a{
  background: #4a69ad;
}
ul li:hover:nth-child(3) a{
  background: #7DF9F9;
}
ul li:hover:nth-child(3) before a{
  background: #2e4a86;
}
ul li:hover:nth-child(3) after a{
  background: #4a69ad;
}
ul li:hover:nth-child(4) a{
  background: #4DB3FF;
}
ul li:hover:nth-child(4) before a{
  background: #2e4a86;
}
ul li:hover:nth-child(4) after a{
  background: #4a69ad;
}
ul li:hover:nth-child(5) a{
  background: #FA8080;
}
ul li:hover:nth-child(5) before a{
  background: #2e4a86;
}
ul li:hover:nth-child(5) after a{
  background: #FEFB35;
}
  ...
  <!-- left side start 
    ...
    -->
          ...
          <div class="top-right links" style="float:right">
              @if (Auth::check())
              <a href="{{url('book')}}" style="background-color:#283E4A;
              color:#fff; padding:5px 15px 5px 15px; border-radius:5px">Find book</a>
                 ...
                 <div class="col-md-1 pull-right">
                    ...
                    <div class="dropdown-menu">
                      <a data-toggle="modal" :data-target="'#myModal' + post.id"
                        @click="openModal(post.id)">Edit</a>
                     <a>some more action</a>
                      <div class="dropdown-divider"></div>
                      <li v-if="post.user_id == '{{Auth::user()->id}}'"></li>
