...
<script src="https://use.fontawesome.com/595a5020bd.js"></script>
        ...
        <title>{{ config('app.name', 'candle') }}</title>
    ...
    <body>
        <div id="app">
                              ...
                              <li><a href="{{url('/requests')}}">My Requests
                                      <span style="color:green; font-weight:bold;
                                       font-size:16px">({{App\friendships::where('status', Null)
                                                  ...
                                                  ->count()}})</span></a></li>
                        <li>  <a href="{{url('jobs')}}"  style="background-color:#283E4A; color:#fff; padding:5px 15px 5px 15px; border-radius:5px; margin:8px">Find Books</a></li>
                            @endif
                        </ul>
                          ...
                          <ul class="dropdown-menu" role="menu" style="width:320px">
                            ...
                            <li>
                                <a href="{{url('/friends')}}" title="friends">
                                 ...
                                 <span class="badge"
                                          style="background: position: relative; top: -15px; left:-10px">
                                 </a>
                            </li>
            ...
            <div >
                ...
                <div class="container"> <p class="pull-right" style="padding: 5px;"></p></div>
            </div>
        </div>
