...
<head>
    ...
    <!-- Bootstrap core CSS     -->
    <link href="{{Config::get('app.url')}}/books_theme/assets/css/bootstrap.min.css" rel="stylesheet" />

    <!-- Animation library for notifications   -->
    <link href="{{Config::get('app.url')}}/books_theme/assets/css/animate.min.css" rel="stylesheet"/>

    <!--  Light Bootstrap Table core CSS    -->
    <link href="{{Config::get('app.url')}}/books_theme/assets/css/light-bootstrap-dashboard.css" rel="stylesheet"/>


    <!--  CSS for Demo Purpose, don't include it in your project     -->
    <link href="{{Config::get('app.url')}}/books_theme/assets/css/demo.css" rel="stylesheet" />


    <!--     Fonts and icons     -->
    <link href="http://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css" rel="stylesheet">
    <link href='http://fonts.googleapis.com/css?family=Roboto:400,700,300' rel='stylesheet' type='text/css'>
    <link href="{{Config::get('app.url')}}/books_theme/assets/css/pe-icon-7-stroke.css" rel="stylesheet" />
...
<div class="wrapper">
    <div class="sidebar" data-color="azure"
		data-image="{{Config::get('app.url')}}/books_theme/assets/img/sidebar-5.jpg">

			    	<div class="sidebar-wrapper">
			            <div class="logo">
			                <a href="{{url('/books')}}" class="simple-text">
			                books
			                </a>
			            </div>
