...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/unfriend/{id}', function($id){
        ...
        //jobs for users
        Route::get('book', 'ProfileController@jobs');
        Route::get('books/{id}','ProfileController@job');
        // delete post
...
Route::group(['prefix' => 'books', 'middleware' => ['auth', 'books']], function () {
 Route::get('/','booksController@index');
 Route::get('/addJob', function(){
   return view('books.addJob');
 });
 Route::get('/jobs','booksController@viewJobs');
 Route::post('addJobSubmit', 'booksController@addJobSubmit');
});
